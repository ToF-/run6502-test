...
#define RDCH    0xFFE0  /* read stdin char in accumulator */
#define WRCH    0xFFE2  /* Write accumulator to stdout. */
...
int main()
{
    ...
    */
    M6502_setCallback(mpu, call, WRCH, wrch);
    M6502_setCallback(mpu, call, RDCH, rdch);
